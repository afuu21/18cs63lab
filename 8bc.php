<?php header('Content-Type: text/plain'); //without this header "\t and \n" wont work
// transpose matrix
$matrix1 = array(array(1, 2), array(4, 5));
$matrix2 = array(array(1, 2), array(4, 5)); echo "\n\n\n";
...
$colCount = count($matrix1[0]); //Provides the column count of matrix echo "The input matrix A is:\n";
...
for ($c = 0; $c < $colCount; $c++) { echo $matrix2[$r][$c] . " \t";
}
echo "\n";
}
...
for ($c = 0; $c < $rowCount; $c++) { echo $matrix1[$c][$r] . " \t";
}
echo "\n";
}
$rowCount = count($matrix1); //Provides the rowcount of matrix
...
//A*B C*D
//B is not equal to C if($colCount == $rowCount2)
{
for($r = 0;$r < $rowCount;$r++)
{
for($c = 0;$c < $colCount;$c++)
