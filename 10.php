...
<body>
    ...
    <?php
        ...
        $crt1="INSERT INTO `student1`(`usn`, `name`, `address`) VALUES ('4vv19cs092','name1','add1')";
        $crt2="INSERT INTO `student1`(`usn`, `name`, `address`) VALUES ('4vv19cs085','name2','add2')";
        $crt3="INSERT INTO `student1`(`usn`, `name`, `address`) VALUES ('4vv19cs093','name3','add3')";
